...
class VerifyUser(forms.Form):
    ...
    password = forms.CharField(label='Nombre', max_length=100, widget=forms.PasswordInput(attrs={'class': 'form-control'}))
    password = forms.CharField(label='Apellido', max_length=100, widget=forms.PasswordInput(attrs={'class': 'form-control'}))